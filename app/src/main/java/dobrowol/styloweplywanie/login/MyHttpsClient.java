...
public class MyHttpsClient extends DefaultHttpClient {
    ...
    public MyHttpsClient(ClientConnectionManager httpConnectionManager, HttpParams params) {
    ...
    private SSLSocketFactory newSslSocketFactory() {
        try {
            ...
            InputStream in = MyHttpsClient.context.getResources().openRawResource(R.raw.emm_truststore); //name of your keystore file here
            try {
                // Initialize the keystore with the provided trusted certificates
                // Provide the password of the keystore
                trusted.load(in, "wpO^W$1155s".toCharArray());
            } finally {
                in.close();
            }
